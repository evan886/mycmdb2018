    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu_auth', models.ManyToManyField(to='menuAuth.menu', blank=True)),
            ],
            options={
                'db_table': 'department',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start', models.CharField(max_length=20, verbose_name='\u5f00\u59cb\u65f6\u95f4')),
                ('end', models.CharField(max_length=20, verbose_name='\u7ed3\u675f\u65f6\u95f4')),
            ],
            options={
                'db_table': 'on_duty',
            },
        ...
        migrations.AddField(
            model_name='myuser',
            name='menu_auth',
            field=models.ManyToManyField(to='menuAuth.menu', blank=True),
        ),
        migrations.AddField(
            model_name='myuser',
