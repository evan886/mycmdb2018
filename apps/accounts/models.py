...
class department(models.Model):
    ...
    menu_auth = models.ManyToManyField(menu, blank=True)
...
class on_duty(models.Model):
    title = models.CharField(max_length=20,verbose_name=u'姓名')
    start = models.CharField(max_length=20,verbose_name=u'开始时间')
    end = models.CharField(max_length=20,verbose_name=u'结束时间')
